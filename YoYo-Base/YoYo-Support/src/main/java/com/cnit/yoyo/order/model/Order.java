package com.cnit.yoyo.order.model;
...
public class Order implements Serializable {
	...
	/** 订单状态 */
	private String status;// create:创建订单;unconfirm:待确认;uninstall:未安装;install:安装中;finish:已完成;dead:已取消;
	/** 确认状态 */
	...
	/** 订单是为主单 1：是 0:否 **/
	private String parentOrderFlag;

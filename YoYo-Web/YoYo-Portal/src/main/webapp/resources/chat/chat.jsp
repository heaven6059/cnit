            ...
            <div class="chatLeft">
                <div class="chat01">
                    <div class="chat01_title">
                        <ul class="talkTo"><li><a href="javascript:;">
                        <input id="nickName" type="hidden" value="${sessionScope.loginName}"/>
                        <c:choose>
						<c:when test="${sessionScope.loginName != '' && !empty sessionScope.loginName}">

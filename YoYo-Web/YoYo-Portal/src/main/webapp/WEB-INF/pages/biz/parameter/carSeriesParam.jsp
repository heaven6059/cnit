...
<head>
    ...
    <link rel="stylesheet" href="${path}/resources/styles/carParams.css?v=${versionVal}" />
</head>
<body>
    ...
    <script type="text/javascript" src="${path}/resources/scripts/biz/parameter/library.js?v=${versionVal}"></script>
    <script type="text/javascript">
    var config = ${result};                
    </script>
    <script type="text/javascript" src="${path}/resources/scripts/biz/parameter/config-min.js?v=${versionVal}"></script>
    <script type="text/javascript" src="${path}/resources/scripts/biz/parameter/seriesParam.js?v=${versionVal}"></script>
    <script type="text/javascript">

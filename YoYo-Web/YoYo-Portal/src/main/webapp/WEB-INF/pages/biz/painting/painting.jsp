...
<head>
	...
	<link href="${path}/resources/styles/base.css?v=${versionVal}" type="text/css" rel="stylesheet">
	<link href="${path}/resources/styles/webUploader/webuploader.css?v=${versionVal}" type="text/css" rel="stylesheet">
	<link href="${path}/resources/styles/painting/painting.css?v=${versionVal}" type="text/css" rel="stylesheet">
	...
	<script src="${path}/resources/scripts/biz/painting/paintingUtil.js?v=${versionVal}"></script>
	<script src="${path}/resources/scripts/biz/painting/painting.js?v=${versionVal}"></script>
	<style type="text/css">
		.question{
                        ...
                        <div class="cell clearfix" id="cell1">
                            ...
                            <div class="right">
                                ...
                                <div class="innerBox hide">
                                    ...
                                    <textarea  name="textarea" class="question"  onfocus="fn1(this)" onblur="fn2(this)" style="color:#B6B6B6">留言不多于100个字符</textarea>
                                </div>
                            </div>

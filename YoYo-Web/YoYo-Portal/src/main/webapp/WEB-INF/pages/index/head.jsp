...
<meta property="qc:admins" content="242266717761717312636" />
<%
     ...
     <c:choose>
		<c:when test="${sessionScope.loginStatus==1}">
			...
			<div class="header_car_save_box" style="display: none;">
		         ...
		         <div class="header_other_child">车型信息未保存，<a href="${portalPath}/register/login">登录</a>或<a href="${portalPath}/register/signup">注册</a>后将会自动保存</div>
   			</div>

 ...
 *                      
 */
package com.cnit.yoyo.system.login.service;
...
import com.cnit.yoyo.cart.controller.CartController;
...
public class SignService {
	public static final Logger log = LoggerFactory.getLogger(SignService.class);
    @Autowired
...
//      ResultObject ro = new ResultObject(headObject, smsCode);
        return ro;
    }

...
public class ComboBoxController {
  ...
  public Object findCarBrand(HttpServletRequest request,@RequestParam(value="identifier" ,required=true)String identifier,String pinyin){
	...
	*/
	@ResponseBody
	  ...
	  */
	  ...
	  public Object findCar(HttpServletRequest request,@RequestParam(value="deptId" ,required=true)Integer deptId,Integer carYearId){
	  	 	HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "010301-18");
	  	 	try {
	  	 		Map<String, Object> param=new HashMap<String,Object>();
	  	 		param.put("deptId", deptId);
	  	 		param.put("carYearId", carYearId);
	  ...
	  @ResponseBody
	  @RequestMapping("/findCarYear")
	  public Object findCarYear(HttpServletRequest request,@RequestParam(value="deptId",required=false) Integer deptId){
	   ...
	   /**
		 * @description <b>查询包含商品的厂商以及车系,并且过滤没有商品的厂商以及车系</b>
		 * @author 王鹏
		 * @version 1.0.0
		 * @data 2015年7月30日
		 * @param request
		...
		*/
	   @ResponseBody
	   @RequestMapping("/findCarDeptHasGoods")
	   public Object findCarDeptHasGoods(HttpServletRequest request,@RequestParam(value="brandId",required=false) Integer brandId){
	   	 	ResultObject resultObject = null;
	        try {
	        	HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "010801-09");
	   ...
	   /**
 		 * @description <b>查询车系年款，并且过滤没有商品的年款</b>
 		 * @author 王鹏
 		 * @version 1.0.0
 		 * @data 2015年7月30日
 		 * @param request
 		...
 		*/
	   @ResponseBody
	   @RequestMapping("/findCarYearHasGoods")
 	   public Object findCarYearHasGoods(HttpServletRequest request,@RequestParam(value="carDeptId",required=false) Integer carDeptId){
 	   	 	ResultObject resultObject = null;
 	        try {
 	        	HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020119-06");
 	   ...
 	   /**
 		 * @description <b>年款条件查询车型，并且过滤没有商品的车型</b>
 		 * @author 王鹏
 		 * @version 1.0.0
 		 * @data 2015年7月30日
 		 * @param request
 		...
 		*/
	   @ResponseBody
	   @RequestMapping("/findCarHasGoods")
 	   public Object findCarHasGoods(HttpServletRequest request,@RequestParam(value="carDeptId",required=false) Integer carDeptId,@RequestParam(value="carYearId",required=false) Integer carYearId){
 	   	 	ResultObject resultObject = null;
 	        try {
 	        	HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "010301-17");
 	        	Map<String, Object> param=new HashMap<String,Object>();
 	        	param.put("carDeptId", carDeptId);
 	        	param.put("carYearId", carYearId);

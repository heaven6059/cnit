 ...
 */
public class PortalDefaultFilterChainManager extends DefaultFilterChainManager {

    private Map<String, String> filterChainDefinitionMap = null;

    private String loginUrl;//配置的登录路径
    private String successUrl;//登录成功跳转的页面
    private String unauthorizedUrl;//没有授权调转的路径

    public PortalDefaultFilterChainManager() {

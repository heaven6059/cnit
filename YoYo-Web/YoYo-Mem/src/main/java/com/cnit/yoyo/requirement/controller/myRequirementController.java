...
public class myRequirementController {
	
    public static final Logger logger = LoggerFactory.getLogger(myRequirementController.class);
    ...
    public String toMyContent(){
    	return "/pages/biz/requirement/myRequiements";
    } 
    ...
    @ResponseBody
    public Object getMyContent(HttpServletRequest request, PostRequirementDTO dto){

...
<div class="add_con">
    ...
    <div class="add_right fr" style="display:none;">
    	<p><i></i>我的购物车</p>
        ...
        <div class="total">
        	共<strong class="red">9</strong>件商品<br />
            金额总计：<strong class="red">139.00</strong>
        </div>
        <div class="btns">
            <a class="add_btn" href="javascript:;">去购物车结算</a>
        </div>
    </div>
</div>
</div>

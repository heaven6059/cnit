...
function appealRefunds(){
	$("#form_1").attr("action","../reship/appealRefunds");
	$("#form_1").submit();
}
</script>
</head>
...
<body>
	...
	<div class="member-main tk2">
		...
		<div class="note clearfix">
			...
			<div class="clearfix">
				...
				<div class="span-auto colborder">
					订单状态： <span>${afterSales.refundText}</span>
				</div>
		...
		<c:choose>
			<c:when test="${fn:startsWith(afterSales.orderId,'333')}">
				<h4 class="lineheight-30">申请退款订单：<a  href="../mypainting/viewOrder?orderId=${afterSales.orderId}" class="dd_color" >${afterSales.orderId}</a></h4>
			</c:when>
			<c:otherwise>
				<h4 class="lineheight-30">申请退款的商品：</h4>
				<table width="100%" cellspacing="0" cellpadding="3" class="gridlist border-all gridlist_member">
					<colgroup>
						<col class="span-4">
						<col class="span-auto">
						<col class="span-4">
		...
		<div style="width: 180px; margin: 10px auto">
			<button type="button" onclick="appealRefunds();" class="btn">

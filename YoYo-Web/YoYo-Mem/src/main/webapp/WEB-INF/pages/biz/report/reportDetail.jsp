...
<script src="${path}/resources/scripts/biz/report/reportDetail.js"></script>
</head>
<body>
					...
					<div class="boxbase msg-board J_MsgBoard">					
						...
						<div class="box-bd">
							...
							<form id="formId" class="box-action  hidden" >
									...
									<input type="hidden" name="authorId" value="${reportDTO.fromMemberId}"> 
								    <input type="hidden" name="author" value="${reportDTO.fromUname}"> 
						...
						<div class="J_MsgDetail">
						  <c:forEach items="${reportDTO.reportComments}" var="reportComment">
							<div class="row-item first-row-item odd">
							    <c:if test="${reportComment.source=='buyer'}"><div class="ctitle avator">自己：</div></c:if>
								<c:if test="${reportComment.source=='seller'}"><div class="ctitle avator">卖家：</div></c:if>
								<div class="info">
									<div class="action">
			...
			<div class="col-sub">
				<div class="request-info boxbase J_RequestInfoWrap ">
					...
					<div class="box-hd">
						...
						<c:if test="${reportDTO.status eq 'intervene'}">
						<div class="box-act">
							<a href="javascript:cancelReport(${reportDTO.reportId});" class="">撤销</a>
						</div>
						</c:if>						
					...
					<div class="box-bd J_RequestInfo">
						...
						<div class="row-item ">
							...
							<div class="report_text" title="${reportDTO.storeName }">${reportDTO.storeName }</div>
						</div>
						<div class="row-item ">
							<div class="ctitle">
								<label>申请时间：</label>
					...
					<div class="box-bd">
						...
						<div class="row-item">
							...
							<div class="info report_text">
								<a target="_blank" href="${portalPath}/shop/index?companyId=${reportDTO.companyId}" title="${reportDTO.storeName}">${reportDTO.storeName}</a> 								
							</div>
						</div>
						<div class="row-item">
							<div class="ctitle">

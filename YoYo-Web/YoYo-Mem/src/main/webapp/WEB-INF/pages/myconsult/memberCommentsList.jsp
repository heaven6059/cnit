...
<body>
		...
		<div class="orderlist-warp">
			...
			<div　class="mc ui-switchable-panel comments-table ui-switchable-panel-selected"　id="comment-0" style="display: block;">
				<div class="com-table-header">
					<span class="item column1">评论内容</span> 
					<span class="item column2">评论商品</span>
					<span class="item column3">评论时间</span> 
				</div>
	...
	<script type="text/javascript" src="${path}/resources/scripts/biz/myconsult/memberComment.js"></script>
</body>
</html>

		...
		success:function(returnData){
			 ...
			 $.each(returnData.rows,function(index,complain){
				 ...
				 if(/^333/.test(complain.orderId)){
					 html.push('<td valign="middle"><span><a target="_blank" class="btn-bj-hover operate-btn" href = "../mypainting/viewOrder?orderId='+complain.orderId+'" >'+complain.orderId+'</a></span></td>');
				 }else{
					 html.push('<td valign="middle"><span><a target="_blank" class="btn-bj-hover operate-btn" href = "../memberOrder/viewOrder?orderId='+complain.orderId+'" >'+complain.orderId+'</a></span></td>');
				 }
				 ...
				 if(/^333/.test(complain.orderId)){
					 html.push('<td valign="middle"><span><a class="btn-bj-hover operate-btn" href = "../mypainting/complainDetail/?complainId='+complain.complainId+'" >查看详情</a></span></td>');
				 }else{
					 html.push('<td valign="middle"><span><a class="btn-bj-hover operate-btn" href = "../memberOrder/complainDetail/?complainId='+complain.complainId+'" >查看详情</a></span></td>');
				 }
				 html.push('</tr>');
			 });

...
public class CategoryController {
    ...
    private Object deleteVirtualCate(HttpServletRequest request, Integer catId) throws Exception {
        ...
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020103-09", GlobalStatic.SYSTEM_CODE_DATA,
    ...
    private Object getVirtualCateDetail(HttpServletRequest request, Integer catId) throws Exception {
        ...
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020103-08", GlobalStatic.SYSTEM_CODE_DATA,
                GlobalStatic.SYSTEM_CODE_BACK);
        ResultObject resultObject = itemService.doService(new RequestObject(headObject, catId));
    ...
    private Object saveOrUpdateVirtualCate(HttpServletRequest request) throws Exception {
        ...
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020103-07", GlobalStatic.SYSTEM_CODE_DATA,
                GlobalStatic.SYSTEM_CODE_BACK);
    ...
    private Object deleteCate(HttpServletRequest request, Integer catId) throws Exception {
        ...
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020103-04", GlobalStatic.SYSTEM_CODE_DATA,
                GlobalStatic.SYSTEM_CODE_BACK);
        ResultObject resultObject = itemService.doService(new RequestObject(headObject, catId));
    ...
    @ResponseBody
    public Object getDetail(HttpServletRequest request, Integer catId,Integer carId) throws Exception {
        log.info("start[CategoryController.getDetail]");
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020103-05", GlobalStatic.SYSTEM_CODE_DATA,
                GlobalStatic.SYSTEM_CODE_BACK);
    ...
    private Object insertCate(HttpServletRequest request) throws Exception {
        ...
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020103-02", GlobalStatic.SYSTEM_CODE_DATA,
                GlobalStatic.SYSTEM_CODE_BACK);
        JSONObject content = new JSONObject();
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setJsonPropertyFilter(new PropertyFilter() {
    ...
    public Object getCateTreeByPid(HttpServletRequest request) throws Exception {
        ...
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020103-15", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
        ResultObject resultObject = itemService.doService(new RequestObject(headObject, params));

...
public class BrandController {
	...
	public Object getBrandBusinessList(HttpServletRequest request, ShopBrandWithBLOBs shopBrand) throws Exception {
		...
		shopBrand.setCompanyId(Long.valueOf(companyId));
   ...
   */
    ...
    *@return
    */
   @RequestMapping("/insertOldBrandBusiness")
   @ResponseBody
   public Object insertOldBrandBusiness(HttpServletRequest request, @RequestParam(value="brandIds[]",required=true)Integer [] brandIds) {
       HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020109-15", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
       ResultObject resultObject = null;
       try {
           Map<String, Object> data = new HashMap<String, Object>();
           Integer companyId = (Integer) CommonUtil.getSession(request).getAttribute("companyId");
    ...
    *@return
    */
   @RequestMapping("/cancelBrandBusiness")
   @ResponseBody
   public Object cancelBrandBusiness(HttpServletRequest request, ShopBrandWithBLOBs shopBrand) {
       HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "2000020109-16", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
       ResultObject resultObject = null;
       try {
           Integer companyId = (Integer) CommonUtil.getSession(request).getAttribute("companyId");
           shopBrand.setCompanyId(Long.valueOf(companyId));

...
public class ImageUploadController {
    ...
    public ResultObject uploadImg(@RequestParam(value = "imageFile", required = false) MultipartFile file, HttpServletRequest request, ModelMap model) {
        ...
        HeadObject head = CommonHeadUtil.geneHeadObject(request, "4000020101-01", GlobalStatic.SYSTEM_CODE_DATA,
        ...
        if (file.getSize() > 2*1024*1024) { // 文件过大
            ...
            try {
                ...
                ImagesDTO imagesDTO = imagesService.uploadSingleFile(file.getBytes(),GlobalStatic.IMAGES_PATH_SHOP); 

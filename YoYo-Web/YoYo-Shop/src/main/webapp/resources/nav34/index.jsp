...
<title>京东商城商品分类导航菜单特效代码</title>
<meta name="keywords" content="jQuery菜单导航,jQuery导航菜单特效,jQuery左侧菜单,jQuery商品分类菜单,京东商城分类菜单" />
<meta name="description" content="JS代码网为广大网友提供jQuery特效,jQuery插件,jQuery导航菜单特效学习和下载" />
...
<div style="height:100px;"></div>
	...
	<div class="wrap">
		<div class="all-sort-list">
			...
			<div class="item">
				<h3><span>·</span><a href="">电脑</a>、<a href="">办公</a></h3>
				<div class="item-list clearfix">
					<div class="close">x</div>
					<div class="subitem">
						<dl class="fore1">
			...
			<div class="item">
				<h3><span>·</span><a href="">家居</a>、<a href="">家具</a>、<a href="">家装</a>、<a href="">厨具</a></h3>
				<div class="item-list clearfix">
					<div class="close">x</div>
					<div class="subitem">
						<dl class="fore1">

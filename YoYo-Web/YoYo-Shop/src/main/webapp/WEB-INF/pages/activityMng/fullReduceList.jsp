...
<script type="text/javascript" src="${path}/resources/scripts/biz/activityMng/fullReduceList.js?v=${versionVal}"></script>
...
<body>
    <div class="member-main fl">
        <!--nav-->
    	<div class="title title2">满减管理</div>
        <form >
        ...
        <div class="sell_con">
            <div class="buy_list clearfix">
            	<table  class="gridlist" width="100%" cellspacing="0" cellpadding="0" border="0" id="tableId">
                	<thead>
                        <tr class="firstTr">
                            <th style=" width: 150px;">满减促销名称</th>

			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="gridlist">
				...
				<c:forEach var="returnProduct" items="${returnProducts.rows}">
					<tr>
					    ...
					    <td class="textcenter">	
					    <c:if test="${returnProduct.isSafeguard eq 2}">
					    ...
					    <c:if test="${returnProduct.isSafeguard eq 1}">
							...
							<a class="font-blue" href="../orderRefundsManager/viewRefunds?refundId=${returnProduct.returnId}">查看</a>
					    </c:if>
						</td>
					</tr>
				</c:forEach>				

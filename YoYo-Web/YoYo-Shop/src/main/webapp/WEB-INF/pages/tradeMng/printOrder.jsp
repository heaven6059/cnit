		...
		<div id="container">
			<div class="pager">
				...
				<table width="100%" cellspacing="0" cellpadding="2" border="0" bgcolor="#F7F7F7" class="p9black">
					<tbody>
						<tr>
							<td width="64" align="center" height="26" class="p9black">货号</td>
							<td width="325" align="center" height="26" class="p9black">商品名称<br></td>
							<td width="90" align="center" height="26" class="p9black">数量</td>
							<td width="90" align="center" height="26" class="p9black">小计</td>
						</tr>
						<c:forEach var="orderItem" items="${order.orderItems}">
						<tr class="row0">
							<td width="64" align="center" height="20">${orderItem.goods.dbn}</td>
							<td width="325" align="center" height="20">${orderItem.product.name}</td>
							<td width="90" align="center" height="20">${orderItem.nums}</td>
							<td width="90" align="center" height="20">￥<fmt:formatNumber value="${orderItem.price}" pattern="#,#00.00#"/></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
				...
				<table width="100%" cellspacing="0" cellpadding="4" border="0"
					...
					<tbody>
						<tr>
							...
							<td width="27%" nowrap="">${order.orderId}</td>
						...
						<tr>
							...
							<td width="39%" nowrap="">￥<fmt:formatNumber value="${order.totalAmount}" pattern="#,#00.00#"/></td>
						</tr>
						<tr>
							...
							<td nowrap="">￥<fmt:formatNumber value="${order.finalAmount}" pattern="#,#00.00#"/></td>
						</tr>
						<tr>
						</tr>
						<tr class="allborder">						
				...
				<table width="100%" cellspacing="0" cellpadding="4" border="0"
					...
					<tbody>
						<tr>
							...
							<td width="27%" nowrap="">${order.member.name}</td>
							<td width="16%" valign="top" nowrap="" align="right"
								class="p9orange">用户名：</td>
							<td width="39%" nowrap="">${order.orderMemberName }</td>
						</tr>
						<tr>
							<td width="18%" valign="top" nowrap="" align="right"
								class="p9orange">电话：</td>
							<td width="27%" nowrap="">${order.member.mobile}</td>
							<td width="16%" valign="top" nowrap="" align="right"
								class="p9orange">Email：</td>
							<td width="39%" nowrap="">${order.member.email}</td>
						</tr>						
						<tr>
							<td valign="top" nowrap="" align="right" class="p9orange">附言：</td>
							<td nowrap="" colspan="3">${order.memo}</td>
						</tr>
					</tbody>
				</table>
				<br>

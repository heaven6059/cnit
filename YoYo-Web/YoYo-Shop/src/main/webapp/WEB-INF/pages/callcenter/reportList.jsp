...
<script type="text/javascript" src="${path}/resources/scripts/biz/callcenter/reportList.js"></script>
...
<body>
	<div class="member-main">
					...
					<tbody>
						<tr>
							...
							<td style="text-align: left; padding-left: 10px;">
							 <input type="text" vtype="text" id="search_productName" maxlength="20" name="search_productName" class="member-x-input " autocomplete="off">
							</td>
							<td style="text-align: right;">举报编号：</td>
							<td style="text-align: left; padding-left: 10px;">
							 <input type="text" vtype="text" id="search_reportId" maxlength="18"  name="search_reportId" class="member-x-input " autocomplete="off" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							</td>
							<td style="text-align: right;">举报原因：</td>
							<td style="text-align: left; padding-left: 10px;">
							 <select class=" member-x-input-select" required="1" name="search_reason" id="search_reason" type="select">
						...
						<tr>
							...
							<td style="text-align: left; padding-left: 10px;">
							 <select class="member-x-input-select" required="1" name="search_status" id="search_status" type="select">
									<option value="">请选择</option>
									<option value="intervene">平台介入</option>
									<option value="voucher">取证中</option>
							...
							<input class="member-x-calendar" size="10" maxlength="10" autocomplete="off" type="text" name="search_startDate" id="search_startDate"
								  vtype="date" onClick="WdatePicker()">
		...
		<div  style="margin-top: 10px; border:none;border-left: 1px solid #ddd;border-bottom: 1px solid #ddd;">
			<table class="gridlist border-all gridlist_member" width="100%" border="0" cellspacing="0" cellpadding="0" id ="reportTableList" style="border: 1px solid #ddd;">
				<tr>
					<th>举报编号</th>
					<th>商品名称</th>
					<th>被举报方</th>

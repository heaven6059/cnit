...
<body>
<script type="text/javascript"  src="${path}/resources/scripts/biz/goodsMng/violationGoods.js?v=${versionVal}"></script>
		...
		<div class="orderlist-warp">
			...
			<div class="Plate">
				<h4>
					...
					<a class="active cur_active"  href="javascript:openDealingGoods();">违规下架的商品</a>
				</h4>
			</div>
			<div class="clr"></div>
			<div class="lineh b4">

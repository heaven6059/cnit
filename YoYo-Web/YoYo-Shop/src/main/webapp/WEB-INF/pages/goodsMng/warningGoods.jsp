...
<body>
<script type="text/javascript"  src="${path}/resources/scripts/biz/goodsMng/warningGoods.js?v=${versionVal}"></script>
<script type="text/javascript"  src="${path}/resources/scripts/biz/goodsMng/goodsIndex.js?v=${versionVal}"></script>
	<div class="member-main member-main2">
		<div class="orderlist-warp">
			<div class="title">预警中的商品</div>
			<!-- <div class="Plate">
				<h4>
				    <a class="active"  href="javascript:openCheckingGoods();"><font color="#333">审核中的商品</font></a>
					...
					<a class="active cur_active"  href="javascript:void(0);">预警中的商品</a> 
			...
			<div class="lineh b4">
				<form id="searchForm">
					<table width="100%" cellspacing="0" cellpadding="0" border="0" style="height: 120px;">
						<%-- <tr>
							<td width="480" colspan="6">设置预警库存：
							<input type="text" style="border:1px solid #d4d4d4" name="storeNum" value="${storeNum }" id="storeNum" class="x-input " onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"> 
							平台设置默认预警库存0 
							<button id="btnSet" class="btn search1" type="button">
								<span><span>设置</span></span>
							</button>
							</td>
						</tr> --%>
						<tr>
							<td width="60">商品名称：</td>
                            <td width="100"><input type="text" style="border:1px solid #d4d4d4" vtype="text" name="name" size="20" class="x-input _clear"> </td>
							<td width="60">商品编号:</td>
                            <td width="100"><input type="text" style="border:1px solid #d4d4d4" vtype="text" name="fbn" size="20"  class="x-input _clear"> </td>
							<td width="60">商品类别:</td>
							<td width="100">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="gridlist">
				<tbody>
					...
					<tr>
			          <td colspan="7" class="p0 list-top bln bnn">

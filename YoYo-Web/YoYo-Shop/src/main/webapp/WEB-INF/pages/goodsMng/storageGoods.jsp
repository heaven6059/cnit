...
<body>
<script type="text/javascript"  src="${path}/resources/scripts/biz/goodsMng/storageGoods.js?v=${versionVal}"></script>
		...
		<div class="orderlist-warp">
			...
			<div class="Plate">
				<h4>
					...
					<a class="active cur_active"  href="javascript:openPutawayGoods();">等待上架的商品</a> 
				...
				<form id="searchForm">
					<table width="100%" cellspacing="0" cellpadding="0" border="0" style="height: 100px;">
						...
						<tr style="margin-top:10px;">
							...
							<td>总销量:</td><td><input type="text" name="minBuyCount" style="border:1px solid #d4d4d4"  class="x-input x-input-width _clear" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"><span style="padding:0px 10px;">到</span><input  type="text" style="border:1px solid #d4d4d4" name="maxBuyCount" class="x-input x-input-width _clear" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"></td>

...
<body>
<script type="text/javascript"  src="${path}/resources/scripts/biz/goodsMng/locationGoods.js?v=${versionVal}"></script>
		...
		<div class="orderlist-warp">
			...
			<div class="Plate">
				<h4>
				    ...
				    <a class="active cur_active"  href="javascript:openLocationGoods();">暂存本地的商品</a>
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="gridlist">
					...
					<tr>
			          <td colspan="8" class="p0 list-top bln bnn">
			            <div class="operations mr_5">
			              ...
			              <button class="trigger-btn" onclick="javascript:operationItem('upOrCheck')" type="button" style="  width: 120px;"> 上 架/提交审核</button>
			            </div>
			          </td>
			        </tr>
				</tbody>
				...
				<tbody>
					<tr class="tr-th">
						<td colspan="8">
						<span class="tcol1">
							<input type="checkbox" name="goodsItem" class="selector" value="${good.goodsId }" checkCat="${good.checkCat}">商品编码:<a href="">${good.fbn}</a>
						</span>
						</td>
					</tr>
					<tr>						
						...
						<td><c:if test="${good.checkCat==0 }">不需审核</c:if><c:if test="${good.checkCat!=0 }">需要审核</c:if></td>

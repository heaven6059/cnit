...
<body>
    ...
    <script type="text/javascript"  src="${path}/resources/scripts/biz/good/brandCarIndex.js?v=${versionVal}"></script>
	...
	<div id="window-add-brand" class="easyui-window" title="添加品牌"
		...
		<form id="form-brand-add" class="easyui-form">
			...
			<table class="add_brand_table">
				<tr>
					<td style="width:30%;text-align:right;"><span style="color: #000;">*</span>品牌名称：</td>

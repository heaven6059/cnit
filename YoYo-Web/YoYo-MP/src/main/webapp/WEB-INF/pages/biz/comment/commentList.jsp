...
<script type="text/javascript" src="${path}/resources/scripts/biz/member/comment.js?t=${time} "></script>
<link type="text/css" href="${path}/resources/styles/comment/comment.css?t=${time}" rel="stylesheet" />
</head>
<body>
	<div id="toolbar">
		&nbsp;
		...
		<in   put type="hidden" id="object_type" value="${objectType}" />
		<a class="easyui-linkbutton" iconCls="icon-search" onclick="openAdvaceQuery('advance_search_comments')">高级筛选</a> 
	</div>
	...
	<div id="advance_search_comments" class="easyui-dialog advance_search" title="高级筛选"
		...
		<form id="comments_search_form" class="easyui-form" method="post"
			...
			<table style="border-collapse: separate; border-spacing: 5px;">
                ...
                <tr>
                    ...
                    <td>
                    	<input name="title" id="title" width="220px"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">评论商品：</td>
                    <td>
	...
	<div id="search_btn">
		<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="commentsSearch();" style="width: 90px">立即筛选</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="clearCommentsSearch();" style="width: 90px">清除条件</a>
	</div>

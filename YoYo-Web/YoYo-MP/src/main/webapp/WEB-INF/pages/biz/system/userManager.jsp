...
<body>
    ...
    <script type="text/javascript" src="${path}/resources/scripts/biz/system/userManager.js"></script>
        ...
        <input type="hidden" name="accountId" id="accountId">
            <table class="add_brand_table">
                <tr>
                    ...
                    <td><input type='text' id="loginName" name="loginName" class="tab_input"  /></td>
                </tr>
                <tr>
                    <td align="right">密码：</td>
                    <td><input type='text' id="loginPassword" name="loginPassword" class="tab_input"  /> </td>
                </tr>
                <tr>

...
<script type="text/javascript" src="${path}/resources/scripts/biz/driveOrReplace/drive.js?t=${time} "></script>
</head>
<body>
	<div id="toolbar">
		<a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="deleteDrive()"> 删除 </a>
		<a href="#" style="margin-left: 5px;" class="easyui-linkbutton" iconCls="icon-search" onclick="openSeachWindow()">高级筛选</a>
	</div>
	
	<table id="drive_list_dataGrid" style="marge: 10px auto;">
	</table>

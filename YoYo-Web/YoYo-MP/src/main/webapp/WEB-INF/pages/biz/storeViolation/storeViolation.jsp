...
<meta http-equiv="expires" content="0">
	...
	<script type="text/javascript" src="${path}/resources/scripts/biz/storeViolation/storeViolation.js"></script>    
</head>
<body>
	...
	<div id="advance_search_store_violation" class="easyui-dialog advance_search" title="高级筛选"

...
<script type="text/javascript" src="${path}/resources/scripts/biz/reportcomplain/report.js?v=${versionVal}"></script>
</head>
<body>
	<div id="panel-goods">
		...
		<table id="report_list_dataGrid" style="marge: 10px auto;">
		</table>
	</div>
	...
	<div id="advance_search_order" class="easyui-dialog advance_search" title="高级筛选" style="background: #F5F5F5" data-options="closed:true,modal:false,cache:false,buttons:'#search_btn'">
		<form id="report_search_form" class="easyui-form" method="post" data-options="novalidate:true">
			<table style="border-collapse: separate; border-spacing: 5px;">
				<tr>
					<td align="right">举报编号: </td>
					<td><input id="reportId" name="reportId" class="easyui-textbox search_class"  style="width: 220px"/></td>
				</tr>
				<tr>
					<td align="right">商品名称: </td>
					<td><input id="productName" name="productName" class="easyui-textbox search_class"  style="width: 220px"/></td>
				</tr>
				<tr>
					<td align="right">被举报方: </td>
	...
	<div id="search_btn">
		<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="reportAdvanceSearch()" style="width: 90px">立即筛选</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="clearReportSearch()" style="width: 90px">清除条件</a>
	</div>
</body>
</html>
...
<link type="text/css"	href="${path}/resources/styles/order/framework.css?v=${versionVal}" rel="stylesheet" />
<link type="text/css"	href="${path}/resources/styles/order/style.css?v=${versionVal}" rel="stylesheet" />

</head>
<body>
	<div class="hide">
		<input id="orderId" type="text" value=<c:out value="${requestScope.orderId}"/> />
	</div>
	<script type="text/javascript" src="${path}/resources/scripts/biz/order/orderDetail.js?v=${versionVal}"></script>
	<div class="easyui-layout" fit="true">
		<div region="center">
			<div id="tabs-order-detail" class="easyui-tabs" style="width: 900px; height: auto" tabPosition="left">
				<div title="基本信息">
						    		...
						    		<div class="tableform">
						        		...
						        		<div class="division">
						          			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="gridlist">
						            			...
						            			<tbody>
						                        	<tr>
										              <td><c:if test="${!empty payment.tBegin}">${payment.tBegin}</c:if></td>
						    		...
						    		<div class="tableform">
						        		...
						        		<div class="division">
						          			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="gridlist">
									            ...
									            <tbody>
									            	<tr>
										              <td><c:if test="${!empty refund.tBegin}">${refund.tBegin}</c:if></td>
				...
				<!-- <div title="顾客留言">
					<div id="order-detail-message-info" style="padding: 0px 20px;">
						<h3>顾客留言</h3>
						<table cellspacing="0" cellpadding="0" style="margin:10px" border="0" width="100%">
							...
							<tr>
													...
													<tbody>
														<tr>
															<td style=" white-space:normal; text-align:left;">
																<a href="/product-272.html" target="_blank">虚拟商品</a>
																<span class="font-orange">×(1)</span>
															</td>
														</tr>
													</tbody>
												</table>
								...
								<td style="vertical-align: top;">
									<table cellspacing="0" cellpadding="0" border="0" width="100%" id="order_form_msg" style="display:none">
										<tbody>
											<tr>
												<td width="40">标题：</td>
												<td height="30">
													<input autocomplete="off" class="x-input " type="text" name="msg[subject]" required="true" maxlength="30" value="Re:" id="dom_el_5c24a71" vtype="text" />									<input type="hidden" name="hid_res_subj" value="Re:" />
												</td>
											</tr>
											<tr>
												<td style="vertical-align: top;">内容：</td>
												<td><textarea type="textarea" name="msg[message]" rows="3" style="width:40%" id="dom_el_5c24a72"></textarea><input type="hidden" name="msg[msg_id]" value="" /></td>
											</tr>
											<tr>
												<td>&nbsp;<input type="hidden" name="msg[orderid]" value="2015041610987940"/></td>
												<td style="padding:5px 0 0 0">
													<button id="btn_msg_do_submit" class="btn" type="button"><span><span>提交留言</span></span></button>								</td>
											</tr>
										</tbody>
									</table>
							...
							<td colspan="2">
								<div class="table-action" style="text-align:center; padding:5px 25px 5px 0;">
									   <label>
									<input type="button"  value="给顾客留言" onclick="$('order_form_msg').style.display=''"/>
									</label>
									<button onclick="$('order_form_msg').style.display=''" class="btn" type="button"><span><span>给顾客留言</span></span></button>				</div>
							</td>
							</tr>
							</tbody>
						</table>

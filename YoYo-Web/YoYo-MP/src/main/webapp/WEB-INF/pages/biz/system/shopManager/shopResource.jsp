...
<body>
    ...
    <script type="text/javascript" src="${path}/resources/scripts/biz/system/shopManager/shopResource.js"></script>
    ...
    <!-- 新增资源-->
    <div id="window-add-resource-manager" class="easyui-window" title="添加用户"

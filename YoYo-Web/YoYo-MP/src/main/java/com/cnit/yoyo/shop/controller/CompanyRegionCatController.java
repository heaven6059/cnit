...
public class CompanyRegionCatController {
     ...
     *@return
     */
    @RequestMapping("/findGoodsCat")
    @ResponseBody
    public Object findGoodsCat(HttpServletRequest request,@RequestParam(value="companyId",required=true)Integer companyId){
         HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "030801-06", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
         ResultObject resultObject = null;
         try {

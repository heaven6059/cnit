...
public class ShopUserController {
    public static final Logger log = LoggerFactory.getLogger(ShopUserController.class);
    ...
    * @throws
    ...
    public String index() {
        return "pages/biz/system/shopManager/shopUser";
    }
    ...
    * @throws
    ...
    public Object getUserManagerList(HttpServletRequest request) throws Exception {
        HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "990104-07", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
    ...
    * @throws
    ...
    public Object findSelect(HttpServletRequest request){
    	 HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "990304-05", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
    ...
    * @throws
     */
    @RequestMapping("/insertShopUserRole")
    @ResponseBody
    public Object insertShopUserRole(HttpServletRequest request,SiteUserRoleDTO siteUserRoleDTO){
    	 ResultObject resultObject = null;
         try {
        	 HeadObject  headObject = CommonHeadUtil.geneHeadObject(request, "990104-08", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
        	 resultObject = memberService.doService(new RequestObject(headObject, siteUserRoleDTO));
		} catch (Exception e) {
			e.printStackTrace();
		}
         return  resultObject ;
   ...
   /* @RequestMapping("/findSelect")
    @ResponseBody
    public Object findSelect(HttpServletRequest request,@RequestParam(value="companyId",required=false)Long companyId){
    ...
    * @throws
    ...
    public Object deleteUser(HttpServletRequest request,@RequestParam(value="id",required=true)Integer id){
    	 HeadObject headObject = CommonHeadUtil.geneHeadObject(request, "990104-09", GlobalStatic.SYSTEM_CODE_DATA, GlobalStatic.SYSTEM_CODE_BACK);
    	 ResultObject resultObject = null;
         try {

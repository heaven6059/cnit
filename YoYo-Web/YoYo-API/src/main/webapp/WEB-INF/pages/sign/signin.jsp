...
<body onkeydown="bindEnter(event)">
	    	...
	    	<div class="login">
	            ...
	            <form id="login-form" class="form">
		            <div class="login_b">
		            	<div class="user">
		                	<span class="fl"></span>
		                    <input class="fr" type="text" name="loginName" id="id_loginName" placeholder="邮箱/用户名/已验证手机" />
		                </div>
		            	<div class="user pws">
		                	<span class="fl"></span>
		                    <input class="fr" type="password" name="loginPassword" id="id_loginPassword" placeholder="密码" />
		                </div>
		            	<div class="code">
		                	<div class="code_ipt fl"><input type="text" name="imgValidation" id="id_imgValidation" placeholder="验证码" /></div>
		                ...
		                <div class="find">
		                    <label><input class="fl" type="checkbox" name="autoLogin" id="id_autoLogin" value="false" /> 自动登录</label>
	...
	<script type="text/javascript" src="${path}/resources/scripts/biz/signin.js"></script>
</body>
</html>
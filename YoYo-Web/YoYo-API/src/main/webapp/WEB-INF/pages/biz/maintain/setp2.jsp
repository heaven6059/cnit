...
<script type="text/javascript" src="${path}/resources/scripts/biz/maintain/setp2.js"></script>
<link rel="stylesheet" type="text/css" href="${path}/resources/styles/maintain/maintain_common220150527.css">
<link rel="stylesheet" type="text/css" 	href="${path}/resources/styles/maintain/maintain_selfcar20150228.css">
</head>
<body>
	<div id="content">
		<div class="titleBox">

...
<script type="text/javascript" src="${path}/resources/scripts/biz/maintain/setp3.js"></script>
<link rel="stylesheet" type="text/css" href="${path}/resources/styles/maintain/maintain_common220150527.css">
<link href="${path}/resources/styles/maintain/self20150228.css" type="text/css" rel="stylesheet"/>
<link type="text/css" rel="stylesheet" href="${path}/resources/styles/maintain/cartitems.css" source="widget"/>
</head>
<body>
<div class="conteBox">
										...
										<div class="item-last item-item item-selected" data="${carMaintain.categoryId}">
											<div class="item-form">
												<div class="cell p-goods">
													<a target="_blank" href="">${carMaintain.productName}</a>
												</div>
												...
												<div class="cell p-quantity">
													<div class="quantity-form">
														...
														<input type="text" id="" maxlength="2" value="1" class="itxt" autocomplete="off"> 
												...
												<input type="hidden" class="item-product" value="${carMaintain.productId}">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="toolbar-right">
									<div class="normal">
										<div class="comm-right">
											<div class="btn-area">
												<a class="submit-btn" href="javascript:void(0);">加入购物车</a>
											</div>

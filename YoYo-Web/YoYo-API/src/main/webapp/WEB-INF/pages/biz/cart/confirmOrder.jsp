...
<script src="${path}/resources/scripts/biz/cart/confirmOrder.js"></script>
<style type="text/css">
	...
	<div id="consignee-addr" class="consignee-addr">
		...
		<div class="consignee-cont consignee-off ui-switchable-panel-body" style="position: relative; height: auto;" id="consignee1">
								...
								<div class="payment" ><!-- style="display:none;" -->
									...
									<div class="mc form">
										<div class="item">
											...
											<div class="sment-mark item-selected" style=""
												id="otherSupportSkus-1"></div>
				...
				<div id="step-4" class="step step-complete">
					...
					<div class="step-title"><a href="${path}/cart/index" id="cartRetureUrl" class="return-edit">返回修改购物车</a><strong>商品清单</strong></div>
					<div class="step-content">

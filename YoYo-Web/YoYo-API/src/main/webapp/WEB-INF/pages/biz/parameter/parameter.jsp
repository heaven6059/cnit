...
<link type="text/css" href="${path}/resources/styles/parameter.css" rel="stylesheet" />
<script type="text/javascript" src="${path}/resources/scripts/biz/parameter/parameter.js"></script>
<style type="text/css">
.choice-pop {
    margin-left: -1px;
    padding-bottom: 2px;
...
<div class="row" id="content">
    <div id="navScrollLeft" class="followcon fl" style="position: fixed; top: 296px; display: block; left: 0px; ">
        <ul class="folul">
        	<c:forEach items="${dtos}" var="dto" varStatus="status">
            <li <c:if test="${status.first}">class="top"</c:if>>
                <a <c:if test="${status.first}">class="active"</c:if> href="#target${dto.catalogId}">${dto.catalogName}</a>
            </li>
            </c:forEach>
        </ul>
    </div> 
                ...
                <div>
                    <table class="tablechoice">
                        <tr>
                            <td class="title">
                                <div>
                                    <p class="title-name red">
                                        	车型图片
                                    </p>
                                    <p>
                                       		 配置状况
                                    </p>
                                    <p class="font-grey999">
                                        ●&nbsp;标配
                                    </p>
                                    <p class="font-grey999">
                                        ○&nbsp;选配
                            ...
                            <td class="text js-text-select js-items-select " data-index="0">
                                <ul class="text-ul">
                                    <li class="text-ul-pic">
                                        <a href="javascript:;">
                                            <img height="90" width="120" src="${imagePath}/${car.iconFile}" title="${car.carName}" alt="${car.keyword}"/>                                            
                                        </a>
                                    </li>
                                    <li class="text-ul-selectcon zindex-103">
                                       <div class="select js-brand" data-toggle="select">
                                            <div class="select-selected">
                                                <span data-key="0">选择品牌</span>
                                                <i class="icon10 icon10-down1"></i>
                                            </div>
                                    ...
                                    <li class="text-ul-selectcon zindex-102">
                                        <div class="select select-disabled js-series" data-toggle="select">
                                            <div class="select-selected">
                                                <span data-key="0">选择车系</span><i class="icon10 icon10-down1"></i>
                                            </div>
                                            <div class="select-option">
                                            	<dl>
                                                </dl>
                                    ...
                                    <li class="text-ul-selectcon zindex-101">
                                        <div class="select select-disabled js-spec" data-toggle="select">
                                            <div class="select-selected">
                                                <span data-key="0">选择车型</span><i class="icon10 icon10-down1"></i>
                                            </div>
                                            <div class="select-option">
                                            	<dl>
                                                </dl>
                                    ...
                                    <li class="text-ul-btncont js-li-btncont text-right">
                                        ...
                                        <a class="js-btn-delete btn btn-small" href="javascript:;">删除</a>
                            ...
                            <td class="text js-text-select js-items-select <c:if test="${status.last}">border-r-no</c:if>" data-index="3">
                                <ul class="text-ul">
                                    ...
                                    <li class="text-ul-selectcon zindex-103">
                                        <div class="select js-brand" data-toggle="select">
                                            <div class="select-selected">
                                                <span data-key="0">选择品牌</span><i class="icon10 icon10-down1"></i>
                                            </div>
                                            <div class="select-option">
                                            	<dl>
                                                </dl>
                                    ...
                                    <li class="text-ul-btncont js-li-btncont text-left">
                                        <a class="js-btn-left btn btn-small btn-disabled" href="javascript:;" <c:if test="${status.index eq 0}">style="display:none"</c:if>>&lt;&lt;</a>
                                        <a class="js-btn-delete btn btn-small btn-disabled" href="javascript:;">删除</a>
                                        <a class="js-btn-right btn btn-small btn-disabled" href="javascript:;" <c:if test="${status.index eq (4-fn:length(cars))}">style="display:none"</c:if>>&gt;&gt;</a>
                                    </li>                                    
                                </ul>
                            </td>
                            </c:forEach>
					...
					<div class="choice-fixed">
		                <table id="tbSpecInfo" class="tableinfo">
		                    <tr>
		                        ...
		                        <td class="text name">
		                            <a href="javascript:;">${car.carName}</a>
		                        </td>
		                        </c:forEach>
								<c:if test="${fn:length(cars)<4}">
								<c:forEach begin="1" end="${4-fn:length(cars)}" varStatus="status">                  
		                    ...
		                    <tr>
		                        ...
		                        <c:forEach var="car" items="${cars}">
		                        <td class="text name">
		                            <a href="javascript:;">${car.storePrice/10000}万</a>
		                        </td>
		                        </c:forEach>
								<c:if test="${fn:length(cars)<4}">
								<c:forEach begin="1" end="${4-fn:length(cars)}" varStatus="status">                  
		                    ...
		                    <tr>
		                        ...
		                        <c:forEach var="car" items="${cars}">
		                        <td class="text name">
		                            <a href="javascript:;">${car.price/10000}万</a>
		                        </td>
		                        </c:forEach>
								<c:if test="${fn:length(cars)<4}">
								<c:forEach begin="1" end="${4-fn:length(cars)}" varStatus="status">                  
...
<!--                 <div class="mouth-more"> -->
<!--                     <a href="javascript:;">点击查看详细口碑对比&gt;&gt;</a> -->
<!--                 </div> -->

 ...
 */
public class PortalRetryLimitHashedCredentialsMatcher extends HashedCredentialsMatcher {

	private Cache<String, AtomicInteger> passwordRetryCache;

    public PortalRetryLimitHashedCredentialsMatcher(CacheManager cacheManager) {

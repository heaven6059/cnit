 ...
 * @version 1.0.0
 */
public class AppServiceMapHolder {
    ...
    public void setConfigLocation(Resource configLocation) {
    	AppServiceMapHolder.configLocation = configLocation;
        if (AppServiceMapHolder.configLocation != null) {
        	AppServiceMapHolder.properties = new Properties();
            try {
            	AppServiceMapHolder.properties.load(configLocation.getInputStream());
            } catch (IOException e) {
